...
try {
  ...
  predictions = getFallbackCrops();
    ...
    res.json({
      ...
      predictions,
      best_crop: aiRecommendation?.best_crop || null,
      top_5_crops: aiRecommendation?.top_5_crops || [],
      alternate_top_5_crops: aiRecommendation?.alternate_top_5_crops || [],
      other_possible_crops: aiRecommendation?.other_possible_crops || [],
      aiRecommendation: aiRecommendation?.aiRecommendation || "AI recommendation currently unavailable.",
      aiRecommendationDetails: aiRecommendation?.aiRecommendationDetails || null
